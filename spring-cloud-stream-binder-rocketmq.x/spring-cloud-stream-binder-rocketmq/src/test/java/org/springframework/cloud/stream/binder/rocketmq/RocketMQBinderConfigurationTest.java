...
@SpringBootTest(classes = { RocketMQBinderConfiguration.class, RocketMQBinderConfigurationTest.class })
public class RocketMQBinderConfigurationTest {
	...
	public void testKafkaBinderProducerListener() {
		...
		Field producerListenerField = ReflectionUtils.findField(
				RocketMQMessageChannelBinder.class, "producerListener",
