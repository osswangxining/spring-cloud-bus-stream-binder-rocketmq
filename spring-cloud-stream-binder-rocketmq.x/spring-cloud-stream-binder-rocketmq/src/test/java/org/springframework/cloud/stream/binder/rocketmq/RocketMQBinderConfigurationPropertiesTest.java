...
@SpringBootTest(classes = { RocketMQBinderConfiguration.class, RocketMQBinderConfigurationPropertiesTest.class })
@TestPropertySource(locations = "classpath:binder-config.properties")
public class RocketMQBinderConfigurationPropertiesTest {
	...
	public void testKafkaBinderConfigurationProperties() throws Exception {
		...
		RocketMQProducerProperties kafkaProducerProperties = new RocketMQProducerProperties();
		kafkaProducerProperties.setBufferSize(12345);
		kafkaProducerProperties.setBatchTimeout(100);
		//kafkaProducerProperties.setCompressionType(RocketMQProducerProperties.CompressionType.gzip);
