 ...
 * @author Xi Ning Wang
 */
public class RocketMQBinderMetrics implements PublicMetrics {

	private final static Logger LOG = LoggerFactory.getLogger(RocketMQBinderMetrics.class);
	...
	public RocketMQBinderMetrics(RocketMQMessageChannelBinder binder,
	...
	public Collection<Metric<?>> metrics() {
		...
		for (Map.Entry<String, RocketMQMessageChannelBinder.TopicInformation> topicInfo : this.binder.getTopicsInUse()
				.entrySet()) {
	...
	private ConsumerFactory<?, ?> createConsumerFactory(String group) {
		...
		if (!props.containsKey(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG)) {
			props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,
					this.binderConfigurationProperties.getRocketMQConnectionString());
		}
