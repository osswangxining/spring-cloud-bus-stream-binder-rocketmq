 ...
 * @author Xi Ning Wang
 */
public class RocketMQBinderJaasInitializerListener implements ApplicationListener<ContextRefreshedEvent>,
	...
	public RocketMQBinderJaasInitializerListener() throws IOException {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		if (event.getSource() == this.applicationContext) {
			RocketMQBinderConfigurationProperties binderConfigurationProperties =
					applicationContext.getBean(RocketMQBinderConfigurationProperties.class);
