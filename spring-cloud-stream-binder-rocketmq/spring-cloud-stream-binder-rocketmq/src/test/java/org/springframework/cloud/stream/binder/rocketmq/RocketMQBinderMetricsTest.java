...
import static org.springframework.cloud.stream.binder.rocketmq.RocketMQBinderMetrics.METRIC_PREFIX;
...
import org.springframework.cloud.stream.binder.rocketmq.RocketMQMessageChannelBinder.TopicInformation;
 ...
 */
public class RocketMQBinderMetricsTest {

	private static final String TEST_TOPIC = "test";

	private RocketMQBinderMetrics metrics;
	...
	@Mock
	private RocketMQMessageChannelBinder binder;

	private Map<String, TopicInformation> topicsInUse = new HashMap<>();

	@Mock
	private RocketMQBinderConfigurationProperties rocketmqBinderConfigurationProperties;
	...
	public void setup() {
		...
		metrics = new RocketMQBinderMetrics(binder, rocketmqBinderConfigurationProperties, consumerFactory);
