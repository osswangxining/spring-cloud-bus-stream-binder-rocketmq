 ...
 * @author Gary Russell
 */
public class RocketMQBinderHealthIndicatorTest {

	private static final String TEST_TOPIC = "test";

	private RocketMQBinderHealthIndicator indicator;
	...
	private final Map<String, RocketMQMessageChannelBinder.TopicInformation> topicsInUse = new HashMap<>();
	...
	public void setup() {
		...
		this.indicator = new RocketMQBinderHealthIndicator(binder, consumerFactory);
	...
	public void kafkaBinderIsUp() {
		...
		topicsInUse.put(TEST_TOPIC, new RocketMQMessageChannelBinder.TopicInformation("group", partitions));
